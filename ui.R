           ...
           tabPanel("Data Upload",
                    sidebarLayout(
                      ...
                      sidebarPanel(width = 3,
                                   ...
                                   actionButton("action_load_example1", "Load Example 1 (TCGA-BRCA)"),
                                   actionButton("action_load_example2", "Load Example 2 (TCGA-UCEC)"),
                                   useShinyjs(),
                                   div(
                                     id = "upload_panel",
                                      ...
                                      conditionalPanel(condition="output.hasRNAData == 1",
                                          sidebarLayout(
                                            ...
                                            sidebarPanel(
                                              ...
                                              helpText("eg. maxExp > 0.5 and var > 0.8 and cv > 0.5\nFilter order: maxExp, var, cv. Check Tutorial for more detail."),
